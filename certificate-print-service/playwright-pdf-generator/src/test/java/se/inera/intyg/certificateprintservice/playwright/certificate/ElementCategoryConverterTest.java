    ...
    assertEquals(
        """
            <div class="box-decoration-clone" style="border: 1px solid black; margin-bottom: 5mm; padding-bottom: 3mm;">
             <h2 class="text-base font-bold uppercase" style="border-bottom: 1px solid black; padding-left: 5mm; padding-right: 5mm;">Name Category</h2>
             <h3 class="text-sm font-bold" style="padding-top: 1mm; padding-left: 5mm; padding-right: 5mm;">Name Question</h3>
