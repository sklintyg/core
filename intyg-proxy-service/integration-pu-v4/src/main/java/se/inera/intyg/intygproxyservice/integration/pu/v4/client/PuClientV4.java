...
import static se.inera.intyg.intygproxyservice.integration.pu.v4.configuration.configuration.PuConstants.SAMORDNING_MONTH_INDEX;
import static se.inera.intyg.intygproxyservice.integration.pu.v4.configuration.configuration.PuConstants.SAMORDNING_MONTH_VALUE_MIN;
...
public class PuClientV4 {

  private final GetPersonsForProfileResponderInterface getPersonsForProfileResponderInterface;

  private final GetPersonsForProfileResponseTypeHandlerV4 getPersonsForProfileResponseTypeHandlerV4;
  ...
  public PuResponse findPerson(PuRequest puRequest) {
    ...
    try {
      ...
      return getPersonsForProfileResponseTypeHandlerV4.handle(getPersonsForProfileResponseType);
    } catch (Exception ex) {
