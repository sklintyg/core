...
class ElementCertificateConverterTest {
  ...
  private static final CertificateDataElement CERTIFICATE_CATEGORY_ELEMENT = CertificateDataElement.builder()
  ...
  @Test
  void shallFilterCertificateDataConfigCategory() {
    final var certificateDTO = CertificateDTO.builder()
        .data(Map.of(ELEMENT_ID, CERTIFICATE_CATEGORY_ELEMENT))
        .build();
