...
class GetUnitMessagesRequestValidatorTest {
  ...
  void setUp() {
    ...
    requestBuilder = GetUnitMessagesRequest.builder()
  ...
  void validRequest() {
    validator.validate(
        requestBuilder
            .messagesQueryCriteria(MessagesQueryCriteriaDTO.builder().build())
            .build()
    );
  }
  ...
  class MessageQueryCriteriaValidation {
    ...
    void shouldThrowErrorIfNoValueSet() {
      ...
      assertEquals("Required parameter missing: MessagesQueryCriteria",
