...
class GetCertificateCandidateServiceTest {
  ...
  @Mock
  private GetCertificateCandidateRequestValidator getCertificateCandidateRequestValidator;
  @Mock
  ...
  void shallThrowIfRequestIsInvalid() {
    ...
    doThrow(IllegalArgumentException.class).when(getCertificateCandidateRequestValidator)
  ...
  void shallReturnResponseWithCertificate() {
    ...
    final var certificateDTO = CertificateDTO.builder()
        ...
        .build();
    final var expectedResponse = GetCertificateCandidateResponse.builder()
        .certificate(
            certificateDTO
        )
        .build();
    ...
    doReturn(Optional.of(certificate)).when(getCertificateCandidateDomainService).get(
    ...
    final var actualResult = getCertificateCandidateService.get(
  ...
  void shallReturnResponseWithoutCertificateWhenNoCandidate() {
    ...
    doReturn(Optional.empty()).when(getCertificateCandidateDomainService).get(
        new CertificateId(CERTIFICATE_ID),
        actionEvaluation
    );
