...
class CertificatesWithQARequestFactoryTest {
  ...
  @Test
  void shallIncludeFromDate() {
    final var request = requestBuilder.build();
    assertEquals(FROM, certificatesWithQARequestFactory.create(request).from());
  }

  @Test
  void shallIncludeToDate() {
    final var request = requestBuilder.build();
    assertEquals(TO, certificatesWithQARequestFactory.create(request).to());
  }
