    ...
    final var expectedConfiguration = ElementConfigurationCategory.builder()
        ...
        .description(
            """
                ...
                <ul><li>Ange om vissa aktiviteter medför risker för individen eller andra.</li><li>Beskriv om din bedömning är baserad på observationer, anamnes eller utredning gjord av någon annan, som till exempel psykolog, arbetsterapeut, audionom, syn- eller hörselpedagog.</li><li>Om det är möjligt, ange också svårighetsgraden på aktivitetsbegränsningarna (lätt, måttlig. stor eller total) samt om begräsningarna varierar.</li><li>Om det är möjligt ange även hur de kan korrigeras med hjälpmedel.</li></ul>
                """)
        .build();
