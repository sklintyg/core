...
<iso:schema
  ...
  <iso:pattern id="q4.1">
    <iso:rule context="//gn:delsvar[@id='4.1']">
      ...
      <iso:assert
        test="matches(normalize-space(tp:cv/tp:code), '^(NEUROPSYKIATRISKT|HABILITERING|ARBETSTERAPEUT|FYSIOTERAPEUT|LOGOPED|PSYKOLOG|VARDCENTRAL|SPECIALISTKLINIK|SKOLHALSOVARD|VARD_UTOMLANDS|HORSELHABILITERING|SYNHABILITERINGEN|DIETIST|OVRIGT_UTLATANDE)$')">
