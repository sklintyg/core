...
<iso:schema
  ...
  <iso:pattern id="q4.1">
    <iso:rule context="//gn:delsvar[@id='4.1']">
      ...
      <iso:assert
        test="matches(normalize-space(tp:cv/tp:code), '^(NEUROPSYKIATRISKT|HABILITERING|ARBETSTERAPEUT|FYSIOTERAPEUT|LOGOPED|PSYKOLOG|SPECIALISTKLINIK|VARD_UTOMLANDS|HORSELHABILITERING|SYNHABILITERING|AUDIONOM|DIETIST|ORTOPTIST|ORTOPEDTEKNIKER|OVRIGT|)$')">
        ...
        HORSELHABILITERING, SYNHABILITERING, AUDIONOM, DIETIST, ORTOPTIST, ORTOPEDTEKNIKER, OVRIGT.
      </iso:assert>
    </iso:rule>
  </iso:pattern>
