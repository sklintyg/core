...
<iso:schema
  ...
  <iso:title>Schematron file for "Läkarutlåtande för assistansersättning
    FK7810" - Version 1.
  </iso:title>
  ...
  <iso:pattern id="q4.1">
    <iso:rule context="//gn:delsvar[@id='4.1']">
      ...
      <iso:assert
        test="matches(normalize-space(tp:cv/tp:code), '^(NEUROPSYKIATRISKT|HABILITERING|ARBETSTERAPEUT|FYSIOTERAPEUT|LOGOPED|PSYKOLOG|VARDCENTRAL|SPECIALISTKLINIK|VARD_UTOMLANDS|HORSELHABILITERING|SYNHABILITERINGEN|DIETIST|OVRIGT_UTLATANDE)$')">
        ...
        SYNHABILITERINGEN, DIETIST, OVRIGT_UTLATANDE.
      </iso:assert>
    </iso:rule>
  </iso:pattern>
