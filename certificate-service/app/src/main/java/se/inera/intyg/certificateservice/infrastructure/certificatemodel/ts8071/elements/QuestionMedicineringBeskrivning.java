...
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.ts8071.elements.QuestionMedicinering.QUESTION_MEDICINERING_FIELD_ID;
...
public class QuestionMedicineringBeskrivning {
  ...
  public static ElementSpecification questionMedicineringBeskrivning() {
    return ElementSpecification.builder()
        ...
        .shouldValidate(
            ShouldValidateFactory.valueBoolean(QUESTION_MEDICINERING_ID)
        )
        .mapping(
