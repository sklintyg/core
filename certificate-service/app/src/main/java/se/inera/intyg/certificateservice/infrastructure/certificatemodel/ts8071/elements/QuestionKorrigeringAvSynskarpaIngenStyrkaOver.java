...
public class QuestionKorrigeringAvSynskarpaIngenStyrkaOver {
  ...
  private QuestionKorrigeringAvSynskarpaIngenStyrkaOver() {
    throw new IllegalStateException("Utility class");
  }

  public static ElementSpecification questionKorrigeringAvSynskarpaIngenStyrkaOver() {
