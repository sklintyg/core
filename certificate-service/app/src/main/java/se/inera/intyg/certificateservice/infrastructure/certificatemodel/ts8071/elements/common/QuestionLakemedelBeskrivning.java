...
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.ts8071.elements.common.QuestionLakemedel.QUESTION_LAKEMEDEL_FIELD_ID;
...
public class QuestionLakemedelBeskrivning {
  ...
  public static ElementSpecification questionLakemedelBeskrivning() {
    return ElementSpecification.builder()
        ...
        .shouldValidate(
            ElementDataPredicateFactory.valueBoolean(QUESTION_LAKEMEDEL_ID)
        )
        .mapping(
