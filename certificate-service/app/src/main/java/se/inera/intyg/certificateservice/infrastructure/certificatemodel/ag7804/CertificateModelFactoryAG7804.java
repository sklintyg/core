...
public class CertificateModelFactoryAG7804 implements CertificateModelFactory {
  ...
  private static final String DESCRIPTION = """
      <b>Läkarintyg om arbetsförmåga – arbetsgivaren skapas från Försäkringskassans läkarintyg för sjukpenning (FK 7804) och används i följande situationer:</b>
      <ul>
  ...
  public CertificateModel create() {
    return CertificateModel.builder()
        ...
        .recipient(null) // TODO: Do we need a reciepient ?
