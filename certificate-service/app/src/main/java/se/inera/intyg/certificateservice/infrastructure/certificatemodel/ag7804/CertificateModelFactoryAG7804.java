...
public class CertificateModelFactoryAG7804 implements CertificateModelFactory {
  ...
  private static final String DESCRIPTION = """
      ...
      <ul>
        ...
        <li>När intygsutfärdande läkaren bedömer att patienten behöver vara sjukfrånvarande längre tid än 14 dagar och att sjukfrånvaron därmed kommer att överstiga sjuklöneperioden. <em>Läkarintyg om arbetsförmåga – arbetsgivaren</em> kan utfärdas för att undvika ett återbesök efter dag 14 och fyller då funktionen som intyg till arbetsgivare både <em>under</em> sjuklöneperioden och <em>efter</em> sjuklöneperioden.</li>
      </ul>
      """;
  ...
  private static final String DETAILED_DESCRIPTION = """
      ...
      <ul>
        ...
        <li><p><b>Sjukpenningtillägg.</b> Att ge arbetstagaren rätt till kompletterande sjukpenningtillägg. De flesta kollektivavtal på svensk arbetsmarknad ger arbetstagare rätt till sjukpenningtillägg vid sjukdom.</p></ul>
