...
public class QuestionGrundForMedicinsktUnderlag {
  ...
  public static final FieldId UTLATANDE_BASERAT_PA_FYSISKT_MOTE_FIELD_ID = new FieldId("fysisktMote");
  public static final FieldId UTLATANDE_BASERAT_PA_DIGITALT_VARDMOTE_FIELD_ID = new FieldId("digitaltMote");
  public static final FieldId UTLATANDE_BASERAT_PA_JOURNALUPPGIFTER_FIELD_ID = new FieldId("journaluppgifter");
  public static final FieldId UTLATANDE_BASERAT_PA_FORALDERS_BESKRIVNING_FIELD_ID = new FieldId("foraldersBeskrivning");
