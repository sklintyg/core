...
@Component
public class TestabilityCertificateFillServiceTS8071V2 implements
  ...
  private static final List<ElementId> MAXIMAL_IDS = List.of(
      ...
      QUESTION_HORSELHJALPMEDEL_POSITION_V2_ID, QUESTION_RORLIGHET_ID,
      ...
      QUESTION_SYNKOPE_BESKRIVNING_ID, QUESTION_STROKE_V1_ID, QUESTION_STROKE_PAVARKAN_V2_ID,
      QUESTION_DIABETES_V1_ID, QUESTION_NEUROLOGISK_SJUKDOM_V2_ID,
      ...
      QUESTION_EPILEPSI_MEDICIN_BESKRIVNING_ID, QUESTION_EPILEPSI_MEDICIN_TIDPUNKT_V2_ID,
      ...
      QUESTION_NJURTRANSPLATATION_TIDPUNKT_ID, QUESTION_KOGNITIV_STORNING_V2_ID,
      QUESTION_DEMENS_V2_ID,
      QUESTION_DEMENS_BESKRIVNING_V2_ID, QUESTION_SOMN_V2_ID, QUESTION_SOMN_BESKRIVNING_ID,
      QUESTION_SOMN_BEHANDLING_ID, QUESTION_MISSBRUK_V2_ID, QUESTION_MISSBRUK_BESKRIVNING_V2_ID,
      QUESTION_MISSBRUK_REMISSION_V2_ID, QUESTION_MISSBRUK_JOURNALUPPGIFTER_V2_ID,
      QUESTION_MISSBRUK_JOURNALUPPGIFTER_BESKRIVNING_V2_ID,
      QUESTION_MISSBRUK_PROVTAGNING_ID, QUESTION_MISSBRUK_VARD_V2_ID,
      QUESTION_MISSBRUK_VARD_BESKRIVNING_V2_ID, QUESTION_LAKEMEDEL_V2_ID,
      QUESTION_LAKEMEDEL_BESKRIVNING_V2_ID, QUESTION_PSYKISK_V2_ID, QUESTION_PSYKISK_BESKRIVNING_ID,
      QUESTION_PSYKISK_TIDPUNKT_V2_ID, QUESTION_INTELLEKTUELL_FUNKTIONSNEDSATTNING_V2_ID,
      QUESTION_INTELLEKTUELL_FUNKTIONSNEDSATTNING_BESKRIVNING_V2_ID,
      QUESTION_MEDICINERING_ID, QUESTION_MEDICINERING_BESKRIVNING_V2_ID,
      QUESTION_OVRIG_BESKRIVNING_ID,
      QUESTION_BEDOMNING_ID, QUESTION_BEDOMNING_RISK_V2_ID, QUESTION_BEDOMNING_OKAND_ID
  );
  ...
  private static final List<ElementId> MINIMAL_IDS = List.of(
      ...
      QUESTION_NJURFUNKTION_ID, QUESTION_NJURTRANSPLATATION_ID,
      QUESTION_KOGNITIV_STORNING_V2_ID, QUESTION_DEMENS_V2_ID,
      QUESTION_SOMN_V2_ID, QUESTION_SOMN_BEHANDLING_ID, QUESTION_MISSBRUK_V2_ID,
  ...
  private static Code getCode(ElementId elementId, TestabilityFillTypeDTO fillType) {
    ...
    throw new IllegalStateException(
        String.format("Code not defined in TS8071V2 fill service for question %s",
            elementId.id()));
