...
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.ts8071.elements.v1.QuestionNeuropsykiatriskLakemedelV1.QUESTION_NEUROPSYKIATRISK_LAKEMEDEL_FIELD_ID;
...
public class QuestionNeuropsykiatriskLakemedelBeskrivningV1 {
  ...
  public static ElementSpecification questionNeuropsykiatriskLakemedelBeskrivningV1() {
    return ElementSpecification.builder()
        ...
        .shouldValidate(
            ElementDataPredicateFactory.valueBoolean(QUESTION_NEUROPSYKIATRISK_LAKEMEDEL_ID)
        )
        .mapping(
