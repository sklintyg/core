...
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.ts8071.elements.common.QuestionBalanssinneBeskrivning.QUESTION_BALANSSINNE_BESKRIVNING_ID;
...
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.ts8071.elements.common.QuestionDemensBeskrivning.QUESTION_DEMENS_BESKRIVNING_ID;
...
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.ts8071.elements.common.QuestionHjartsjukdomBehandladBeskrivning.QUESTION_HJARTSJUKDOM_BEHANDLAD_BESKRIVNING_ID;
...
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.ts8071.elements.common.QuestionHorselhjalpmedel.QUESTION_HORSELHJALPMEDEL_ID;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.ts8071.elements.common.QuestionHorselhjalpmedelPosition.QUESTION_HORSELHJALPMEDEL_POSITION_ID;
...
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.ts8071.elements.common.QuestionKorrigeringAvSynskarpaIngenStyrkaOver.QUESTION_KORRIGERING_AV_SYNSKARPA_STRYKA_OVER_ID;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.ts8071.elements.common.QuestionKorrigeringAvSynskarpaKontaktlinser.QUESTION_KONTAKTLINSER_ID;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.ts8071.elements.common.QuestionKorrigeringAvSynskarpaStyrkaOver.QUESTION_KORRIGERING_AV_SYNSKARPA_STRYKA_UNDER_ID;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.ts8071.elements.common.QuestionLakemedel.QUESTION_LAKEMEDEL_ID;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.ts8071.elements.common.QuestionLakemedelBeskrivning.QUESTION_LAKEMEDEL_BESKRIVNING_ID;
...
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.ts8071.elements.common.QuestionMissbrukJournaluppgifterBeskrivning.QUESTION_MISSBRUK_JOURNALUPPGIFTER_BESKRIVNING_ID;
...
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.ts8071.elements.common.QuestionMissbrukVard.QUESTION_MISSBRUK_VARD_ID;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.ts8071.elements.common.QuestionMissbrukVardBeskrivning.QUESTION_MISSBRUK_VARD_BESKRIVNING_ID;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.ts8071.elements.common.QuestionNeurologiskSjukdom.QUESTION_NEUROLOGISK_SJUKDOM_ID;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.ts8071.elements.common.QuestionNeurologiskSjukdomBeskrivning.QUESTION_NEUROLOGISK_SJUKDOM_BESKRIVNING_ID;
...
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.ts8071.elements.common.QuestionPsykisk.QUESTION_PSYKISK_ID;
...
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.ts8071.elements.common.QuestionPsykiskTidpunkt.QUESTION_PSYKISK_TIDPUNKT_ID;
...
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.ts8071.elements.common.QuestionSjukdomshistorikBeskrivning.QUESTION_SJUKDOMSHISTORIK_BESKRIVNING_ID;
...
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.ts8071.elements.common.QuestionStrokePavarkan.QUESTION_STROKE_PAVARKAN_ID;
