...
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.tstrk8071.CertificateModelFactoryTSTRK8071.TSTRK8071_V1_0;
...
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.tstrk8071.elements.QuestionArytmiBeskrivning.QUESTION_ARYTMI_BESKRIVNING_ID;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.tstrk8071.elements.QuestionBalanssinne.QUESTION_BALANSSINNE_ID;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.tstrk8071.elements.QuestionBalanssinneBeskrivning.QUESTION_BALANSSINNE_BESKRIVNING_ID;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.tstrk8071.elements.QuestionBaseratPa.QUESTION_BASERAT_PA_ID;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.tstrk8071.elements.QuestionBaseratPaDatum.QUESTION_BASERAT_PA_DATUM_ID;
...
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.tstrk8071.elements.QuestionBedomningOkand.QUESTION_BEDOMNING_OKAND_ID;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.tstrk8071.elements.QuestionBedomningRisk.QUESTION_BEDOMNING_RISK_ID;
...
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.tstrk8071.elements.QuestionDemensBeskrivning.QUESTION_DEMENS_BESKRIVNING_ID;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.tstrk8071.elements.QuestionDiabetes.QUESTION_DIABETES_ID;
...
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.tstrk8071.elements.QuestionEpilepsiAnfallBeskrivning.QUESTION_EPILEPSI_ANFALL_BESKRIVNING_ID;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.tstrk8071.elements.QuestionEpilepsiBeskrivning.QUESTION_EPILEPSI_BESKRIVNING_ID;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.tstrk8071.elements.QuestionEpilepsiMedicin.QUESTION_EPILEPSI_MEDICIN_ID;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.tstrk8071.elements.QuestionEpilepsiMedicinBeskrivning.QUESTION_EPILEPSI_MEDICIN_BESKRIVNING_ID;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.tstrk8071.elements.QuestionEpilepsiMedicinTidpunkt.QUESTION_EPILEPSI_MEDICIN_TIDPUNKT_ID;
...
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.tstrk8071.elements.QuestionHjartsjukdomBehandladBeskrivning.QUESTION_HJARTSJUKDOM_BEHANDLAD_BESKRIVNING_ID;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.tstrk8071.elements.QuestionHjartsjukdomBeskrivning.QUESTION_HJARTSJUKDOM_BESKRIVNING_ID;
...
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.tstrk8071.elements.QuestionHorselhjalpmedelPosition.QUESTION_HORSELHJALPMEDEL_POSITION_ID;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.tstrk8071.elements.QuestionIdentitet.QUESTION_IDENTITET_ID;
...
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.tstrk8071.elements.QuestionLakemedelBeskrivning.QUESTION_LAKEMEDEL_BESKRIVNING_ID;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.tstrk8071.elements.QuestionMedicinering.QUESTION_MEDICINERING_ID;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.tstrk8071.elements.QuestionMedicineringBeskrivning.QUESTION_MEDICINERING_BESKRIVNING_ID;
...
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.tstrk8071.elements.QuestionMedvetandestorningTidpunkt.QUESTION_MEDVETANDESTORNING_TIDPUNKT_ID;
...
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.tstrk8071.elements.QuestionMissbrukBeskrivning.QUESTION_MISSBRUK_BESKRIVNING_ID;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.tstrk8071.elements.QuestionMissbrukJournaluppgifter.QUESTION_MISSBRUK_JOURNALUPPGIFTER_ID;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.tstrk8071.elements.QuestionMissbrukJournaluppgifterBeskrivning.QUESTION_MISSBRUK_JOURNALUPPGIFTER_BESKRIVNING_ID;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.tstrk8071.elements.QuestionMissbrukProvtagning.QUESTION_MISSBRUK_PROVTAGNING_ID;
...
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.tstrk8071.elements.QuestionMissbrukVardBeskrivning.QUESTION_MISSBRUK_VARD_BESKRIVNING_ID;
...
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.tstrk8071.elements.QuestionNeuropsykiatriskLakemedelBeskrivning.QUESTION_NEUROPSYKIATRISK_LAKEMEDEL_BESKRIVNING_ID;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.tstrk8071.elements.QuestionNeuropsykiatriskTidpunkt.QUESTION_NEUROPSYKIATRISK_TIDPUNKT_ID;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.tstrk8071.elements.QuestionNeuropsykiatriskTrafikrisk.QUESTION_NEUROPSYKIATRISK_TRAFIKRISK_ID;
...
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.tstrk8071.elements.QuestionNjurtransplatationTidpunkt.QUESTION_NJURTRANSPLATATION_TIDPUNKT_ID;
...
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.tstrk8071.elements.QuestionPsykiskBeskrivning.QUESTION_PSYKISK_BESKRIVNING_ID;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.tstrk8071.elements.QuestionPsykiskTidpunkt.QUESTION_PSYKISK_TIDPUNKT_ID;
...
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.tstrk8071.elements.QuestionPsykiskUtvecklingsstorningAllvarlig.QUESTION_PSYKISK_UTVECKLINGSSTORNING_ALLVARLIG_ID;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.tstrk8071.elements.QuestionRorlighet.QUESTION_RORLIGHET_ID;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.tstrk8071.elements.QuestionRorlighetBeskrivning.QUESTION_RORLIGHET_BESKRIVNING_ID;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.tstrk8071.elements.QuestionRorlighetHjalpaPassagerare.QUESTION_RORLIGHET_HJALPA_PASSAGERARE_ID;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.tstrk8071.elements.QuestionSjukdomEllerSynnedsattning.QUESTION_SJUKDOM_ELLER_SYNNEDSATTNING_ID;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.tstrk8071.elements.QuestionSjukdomEllerSynnedsattningBeskrivning.QUESTION_SJUKDOM_ELLER_SYNNEDSATTNING_BESKRIVNING_ID;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.tstrk8071.elements.QuestionSjukdomshistorik.QUESTION_SJUKDOMSHISTORIK_ID;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.tstrk8071.elements.QuestionSjukdomshistorikBeskrivning.QUESTION_SJUKDOMSHISTORIK_BESKRIVNING_ID;
...
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.tstrk8071.elements.QuestionSomnBehandling.QUESTION_SOMN_BEHANDLING_ID;
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.tstrk8071.elements.QuestionSomnBeskrivning.QUESTION_SOMN_BESKRIVNING_ID;
...
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.tstrk8071.elements.QuestionStrokePavarkan.QUESTION_STROKE_PAVARKAN_ID;
...
import static se.inera.intyg.certificateservice.infrastructure.certificatemodel.tstrk8071.elements.QuestionSynkopeBeskrivning.QUESTION_SYNKOPE_BESKRIVNING_ID;
