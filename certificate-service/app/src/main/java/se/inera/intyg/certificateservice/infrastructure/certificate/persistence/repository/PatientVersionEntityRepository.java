...
@Repository
public interface PatientVersionEntityRepository extends JpaRepository<PatientVersionEntity, Integer> {
  ...
  List<PatientVersionEntity> findCoveringTimestampOrderByMostRecent(@Param("id") String id, @Param("ts") LocalDateTime ts);
}
