...
class PdfGeneratorValueToolkitTest {
  ...
  private static final PdfGeneratorValueToolkit pdfGeneratorValueToolkit = new PdfGeneratorValueToolkit();
  ...
  class Value {
    ...
    void shouldThrowExceptionIfFieldDoesntExist() {
      assertThrows(
          ...
          () -> pdfGeneratorValueToolkit.setValue(pdAcroForm, FIELD_NOT_EXISTS, VALUE)
      );
    }

    @Test
    void shouldSetValueIfFieldExists() throws IOException {
      pdfGeneratorValueToolkit.setValue(pdAcroForm, FIELD_EXISTS, VALUE);
    ...
    void shouldNotSetValueIfValueIsNull() throws IOException {
      pdfGeneratorValueToolkit.setValue(pdAcroForm, FIELD_EXISTS, null);
  ...
  class Checkbox {
    ...
    void shouldThrowExceptionIfFieldDoesntExist() {
      assertThrows(
          IllegalStateException.class,
          () -> pdfGeneratorValueToolkit.setCheckedBoxValue(pdAcroForm, FIELD_NOT_EXISTS)
      );
    }

    @Test
    void shouldSetValueIfFieldExists() throws IOException {
      pdfGeneratorValueToolkit.setCheckedBoxValue(pdAcroForm, CHECKBOX_FIELD_EXISTS);
