...
class PdfGeneratorTextToolkitTest {
  ...
  private static final PdfGeneratorTextToolkit pdfGeneratorTextToolkit = new PdfGeneratorTextToolkit();
  ...
  void shouldAddTextToDocument() throws IOException {
    pdfGeneratorTextToolkit.addText(document, VALUE, 10, null, Color.gray);
  ...
  void shouldAddTextWithOffsetToDocument() throws IOException {
    pdfGeneratorTextToolkit.addText(document, VALUE, 10, null, Color.gray, 10F, 10F, false);
