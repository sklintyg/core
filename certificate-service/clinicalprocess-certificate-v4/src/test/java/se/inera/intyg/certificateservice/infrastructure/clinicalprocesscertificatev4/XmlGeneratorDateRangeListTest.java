...
class XmlGeneratorDateRangeListTest {
    ...
    private static final String RANGE_ID_2 = "RANGE_ID_2";
    ...
    class OneDateRange {
        ...
        void shouldMapDelsvarForCode() {
            ...
            final var cvType = (CVType) response.get(0).getDelsvar().get(0).getContent().get(0);
            assertAll(
        ...
        void shouldMapDelsvarForDateRange() {
            ...
            final var dateRange = (DatePeriodType) response.get(0).getDelsvar().get(1).getContent()
                .get(0);
            assertAll(
                () -> assertEquals(2, delsvar.size()),
    ...
    class SeveralDateRanges {
        ...
        void shouldMapFirstDelsvarForCode() {
            ...
            final var cvType = (CVType) delsvarCode.getContent().get(0);
        ...
        void shouldMapFirstDelsvarForDateRange() {
            ...
            final var dateRange = (DatePeriodType) delsvarDateRange.getContent()
                .get(0);
            assertAll(
                () -> assertEquals(2, delsvar.size()),
                () -> assertEquals(QUESTION_ID + ".2", delsvarDateRange.getId()),
