...
import static se.inera.intyg.certificateservice.domain.action.model.CertificateActionType.COMPLEMENT;
...
class ComplementCertificateDomainServiceTest {
  ...
  void shallThrowExceptionIfUserHasNoAccessToComplement() {
    ...
    assertThrows(CertificateActionForbidden.class,
        () -> complementCertificateDomainService.complement(CERTIFICATE_ID, ACTION_EVALUATION,
            EXTERNAL_REFERENCE)
    );
  }
  ...
  void shallReturnNewCertificate() {
    ...
    final var actualCertificate = complementCertificateDomainService.complement(CERTIFICATE_ID,
  ...
  void shallPublishComplementCertificateEvent() {
    ...
    assertAll(
        () -> assertEquals(CertificateEventType.COMPLEMENT,
