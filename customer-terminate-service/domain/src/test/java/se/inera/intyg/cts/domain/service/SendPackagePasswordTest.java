...
class SendPackagePasswordTest {
    ...
    void setUp() {
      ...
      sendPackagePassword = new SendPackagePassword(sendPassword, terminationRepository);
    }
    ...
    public void shouldUpdateTerminationWhenSuccessfulPassword() {
      ...
      assertEquals(TerminationStatus.PASSWORD_SENT, termination(termination.terminationId()).status());
    }
    ...
    public void shouldNotUpdateTerminationWhenFailedPassword() {
      ...
      assertEquals(TerminationStatus.RECEIPT_RECEIVED, termination(termination.terminationId()).status());
    }
