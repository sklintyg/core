...
class SendSMSImplTest {
    ...
    @BeforeEach
    void initialize() {
        sendSMS = new SendSMSImpl(WebClient.create(baseUrl), scheme, baseUrl, mockBackEnd.getPort(), tellustalkSendEndpoint, "Username", "Password");
    }
    ...
    void sendSMS() throws JsonProcessingException, InterruptedException {
        ...
        mockBackEnd.enqueue(new MockResponse().setBody(objectMapper.writeValueAsString(smsResponseDTO)).addHeader("Content-Type", "application/json"));
